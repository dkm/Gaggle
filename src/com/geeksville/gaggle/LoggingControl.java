...
public class LoggingControl extends ListActivity implements LifeCyclePublisher,
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    try {
      showAltButton = BarometerClient.create(this) != null
        ...
        if (prefs.isLiveUpload()) {
          try {
            ...
            PositionWriter liveWriter = new LeonardoLiveWriter(
                LoggingControl.this, acct.serverURL, acct.username,
            ...
            showCompletionDialog(
                LoggingControl.this.getString(R.string.leonardolive_problem),
                ex.getMessage());
          }
        }
